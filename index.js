...
// // node单线程 fs.readFile fs.writeFile等异步方法
// let fs = require('fs');
// // promise化异步操作
// // let readFile = promisify(fs.readFile);
// // let writeFile = promisify(fs.writeFile);

// function promisify (func) { // 用于单个promisi
//     return function (...arg) {
//         return new Promise((res, rej) => {
//             func(...arg, (err, data) => {
//                 if (err) {
...
// //     console.log(val);
// // })
// // 用于多个promisi 基于 promisify
// function promisifyAll (obj) {// fs
//     for (let key in obj) {
//         let fn = obj[key];
//         if (typeof fn === 'function') { 
//             console.log(1)
//             obj[key + 'Async'] = promisify(fn);//把fs的属性函数都绑定promisify
//         }
//     }
// }
// promisifyAll(fs);
...
//     try{
//         let val1 = await readFile(url); // 等待得到val之后再执行
...
// 并发异步操作 几个操作，几个结果，就算有失败的也能返回其他成功的值
...
//     let val3 = null;
//     try {
//         val3 = await readFile('./data/score.txt');
//         console.log(val3);
//     }catch(e) {
//         console.log(e)
//     }
